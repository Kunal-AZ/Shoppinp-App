...
const products = [
  ...
  },
  {
    ...
    gender: "women",
    category: "occasion",
    image: "images/sale0.webp",
    images: ["images/sale0.webp"],
    badge: "Just Added",
    shortDescription: "Relaxed lounge styling with a bright everyday finish.",
    description: "A soft lounge-ready set with a comfortable silhouette and easy styling that works for casual home days and off-duty looks.",
    details: ["Soft feel", "Relaxed fit", "Everyday comfort", "Casual set styling"]
  },
  {
    id: 16,
    title: "Street Denim Edit",
    price: 2799,
    gender: "women",
    category: "tops",
    image: "images/sale1.webp",
    images: ["images/sale1.webp"],
    badge: "Trend Drop",
    shortDescription: "Casual denim styling paired with a sharp crop top look.",
    description: "A trend-led everyday look with easy denim volume and a fitted top that adds fresh high-street energy to the storefront.",
    details: ["Denim-led styling", "Casual fit", "Streetwear mood", "Day-ready look"]
  },
  {
    id: 17,
    title: "Active Weekend Shorts",
    price: 1999,
    gender: "men",
    category: "tops",
    image: "images/sale2.webp",
    images: ["images/sale2.webp"],
    badge: "Sport Edit",
    shortDescription: "Easy activewear built for movement and laid-back comfort.",
    description: "A sporty casual look made for weekend wear, light activity, and effortless summer styling with a clean athletic profile.",
    details: ["Sport-casual look", "Lightweight feel", "Comfort fit", "Weekend ready"]
  },
  {
    id: 18,
    title: "Cargo Jogger Set",
    price: 2999,
    gender: "women",
    category: "occasion",
    image: "images/sale3.webp",
    images: ["images/sale3.webp"],
    badge: "New Season",
    shortDescription: "An easy utility-inspired set for casual everyday dressing.",
    description: "A street-ready pairing with jogger energy, utility pockets, and a laid-back shape that broadens the catalog beyond dress-focused looks.",
    details: ["Utility styling", "Relaxed silhouette", "All-day wear", "Modern casual set"]
  },
  {
    id: 19,
    title: "Breezy Summer Vest",
    price: 1899,
    gender: "men",
    category: "tops",
    image: "images/sale4.jpg",
    images: ["images/sale4.jpg"],
    badge: "Summer Pick",
    shortDescription: "Sleeveless summer styling with a breezy relaxed cut.",
    description: "A casual sleeveless top that brings easy vacation styling, lightweight comfort, and a more youthful men’s edit into the storefront.",
    details: ["Sleeveless cut", "Relaxed fit", "Summer-ready", "Casual daily wear"]
  },
  {
    id: 20,
    title: "Lounge Perfect Pyjamas",
    price: 2299,
    gender: "women",
    category: "occasion",
    image: "images/sale6.jpg",
    images: ["images/sale6.jpg"],
    badge: "Comfort Wear",
    shortDescription: "Printed pyjama styling made for comfort-first shopping.",
    description: "A loungewear look with an easy silhouette and playful print that adds homewear versatility to the mixed catalog.",
    details: ["Soft lounge feel", "Printed design", "Relaxed shape", "Homewear essential"]
  },
  {
    id: 21,
    title: "Summer Trio Look",
    price: 2599,
    gender: "women",
    category: "tops",
    image: "images/sale7.jpg",
    images: ["images/sale7.jpg"],
    badge: "Summer Edit",
    shortDescription: "Light seasonal styling with a casual warm-weather mood.",
    description: "A fresh summer outfit that blends easy separates and trend-led color into a storefront-friendly casual pick.",
    details: ["Seasonal styling", "Casual summer look", "Lightweight outfit", "Street-ready mood"]
  },
  {
    id: 22,
    title: "Metro White Shirt",
    price: 3199,
    gender: "men",
    category: "tops",
    ...
    badge: "Smart Casual",
    shortDescription: "A crisp shirt look built for smart everyday dressing.",
    description: "A clean men’s fashion staple with a polished white shirt, sleek styling, and versatile appeal across work and evening wear.",
    details: ["Clean shirt styling", "Smart casual", "Day-to-night wear", "Timeless men’s staple"]
  },
  {
    id: 23,
    title: "Evergreen Sweatshirt",
    price: 2899,
    gender: "men",
    category: "tops",
    image: "images/cms-banner.jpg",
    images: ["images/cms-banner.jpg"],
    badge: "Everyday Basic",
    shortDescription: "A clean sweatshirt essential for off-duty layering.",
    description: "A laid-back men’s top that adds everyday simplicity, easy layering, and casual comfort to the broader catalog.",
    details: ["Crew neck look", "Relaxed casual fit", "Light layering piece", "Daily wear essential"]
  }
];
